        ...
        <div className="grid grid-cols-2 h-full">
            <div className="flex flex-col justify-center items-center gap-20">
                <div className={`w-[30rem] ${styles.btnOurTrust1}`}>
                    ...
                    <h2 className={`${ebGaramond.className} text-[2.5rem] font-semibold`}>100’000€ comprando una casa low-cost da essere restaurata</h2>
                </div>
            ...
            <div className="flex justify-center items-center pe-[10vw] flex-col gap-12">
                <Image src={graphBar} width={100} height={100} className="object-contain w-[100%] h-[30rem]" alt="life"></Image>
